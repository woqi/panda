  ...
  return (
    <main className='main-seven'>
      ...
      <div className='main-wrap'>
        <div id='heros' className='main-title'>OUR HEROS</div>
        <div className='main-sub-title'>PALADIN & KNIGHTS TEAM</div>
        <ul className='hero-wrap'>
          {bigHeroLists.map((item, idx) => (
            <li className='hero-item'>
              <img className='hero-img' src={`/src/assets/pc/hero${idx + 1}.png`}></img>
        ...
        <div id='faq' className='ask-wrap'>
          ...
          <div className='ask-desc'>
            Pandapunk 2169 is a community driven Web3 Gamefi & Metaverse project. Using NFT as the
            brand value, PPP and PPT as the token economic model to build a brand new Pandaren
            Ecosystem.
          </div>
          <div className='ask-third-title'>HOW MANY TOTAL NFTs & CHARACTERS ?</div>
          <div className='ask-third-title'>ARE THE DIFFERENT LEVELS OF NFTS ?</div>
          <div className='ask-third-title'>HOW TO GET THE PANDAPUNK 2169 NFTS ?</div>
          <div className='ask-third-title'>WILL THERE REALLY BE A PANDAPUNK 2169 METAVERSE ?</div>
          <div className='ask-green-third-title'>
            FIGHT FOR THE PANDAREN. PANDAPUNK 2169 FLAME BURING Web3
          </div>
        </div>
      </div>
    </main>
